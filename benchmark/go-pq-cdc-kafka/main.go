...
import (
	...
	cdc "github.com/s3-go/go-pgx-cdc-kafka"
	"github.com/s3-go/go-pgx-cdc-kafka/config"
	cdcconfig "github.com/s3-go/go-pgx-cdc/config"
	"github.com/s3-go/go-pgx-cdc/pq/publication"
	"github.com/s3-go/go-pgx-cdc/pq/slot"
